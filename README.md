![header](https://capsule-render.vercel.app/api?text=Marmin-Dev&animation=fadeIn)
     ...
     <a href="https://github.com/marmin-dev/ReactJsSpringBootWebservice">프로젝트 레포지토리 가기</a>
      ...
      <div>
        ...
        질문을 올리고 수정, 삭제가 가능하며 질문에 댓글을 달고 좋아요를 누르는 것이 가능하다. 또한 답변을 달고 답변에 댓글을 달거나 답변에 추천하는 것이 가능하다
          ...
          <br>
          <br>
          <h2>너의 사연은? - 곡간의 유사도에 따른 재생 목록 편성및 사연의 감정 분석 기반 추천곡 및 신청곡 서비스</h2>
          <p>2023.06.28 ~ 2023.08.08</p>
          <div>
            문제정의
            <br/>
            가게나 여러 공간에서 음악은 분위기에 중요한 요소이다. 또한 특정 음악을 들으며 사연이나 어떤 일들을 공유하는
            <br/>
            어떤 특정한 공간에서 내 사연이나 게시물을 공유하는 소통이 필요하다고 생각했다.
            <br/>
            그래서 신청곡을 신청하고, 사연을 공유하는 플랫폼을 만들기위해 사전 조사를 진행했다. 
            <br/>
            신청곡을 받으면 갑자기 곡의 분위기가 전환되어 갑자기 가게의 분위기가 전환되거나 하는 상황이 발생이 가능하다.
            <br/>
            또한 내가 자주 듣는 노래의 분위기의 노래가 나오는 가게를 추천받고 싶을 수도 있다고 생각되었다.
            <br/>
            문제 해결
            <br/>
            갑자기 다른 분위기의 노래로 전환되지 않도록 플레이리스트 곡간의 유사도를 바탕으로 유클리디안 거리를 구해 다익스트라 
            <br/>
            알고리즘을 통해 곡들 분위기간의 최소 거리를 구해 플레이리스트를 재배치한다.
            <br/>
            사연, 게시물을 올리고 AI 모델을 통해 내용을 분석하여 해당 감정을 분석하고, 아닐 경우 선택이 가능하도록한다.
            <br/>
            소통의 문제를 해결하기 위해
            곡을 러셀 모델에 따라 감정별로 분류하고, 내용 감정 분석에 따른 곡을 추천해준다.
            <br/>
            어떤 분위기의 노래가 나오는 가게 추천을 위해 내가 신청한 곡들을 바탕으로 가게의 신청곡들을 종합하여,
            <br/>
            내가 자주 신청한 분위기의 노래가 자주 플레이되는 가게를 추천해준다.
            <br/>
            데이터 분석, 음악 스트리밍은 SpotifyAPI를 통해 진행하였다.
            <br/>
            <a href="https://github.com/marmin-dev/Music-Frontend">프론트엔드 레포지토리 바로가기</a>
            <br/>
            <a href="https://github.com/marmin-dev/story-backend">메인 로직 백엔드 레포지토리 바로가기</a>
            <br/>
          <a href="https://github.com/MeanOfRedStone/modelTest">AI 모델 API 레포지토리 바로가기</a>
            <br/>
          </div>
</div>
